...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="display: flex; flex-wrap: wrap; gap: 15px; padding-left: 25px; padding-right: 75px; justify-content: flex-start;">
    
    <img src="imgWeb/clutch.png" alt="Player 1" style="width: 30%; height: auto; border-radius: 5px;" />
    
    <img src="imgWeb/mascot.png" alt="Player 2" style="width: 30%; height: auto; border-radius: 5px;" />
